...
Route::middleware("auth:delivery")->group(function () {
    ...
    //* Express delivery
    Route::get('/fetch/express/calls', [ExpressDeliveryController::class, 'fetchExpressCalls']);
    Route::post('/take/express', [ExpressDeliveryController::class, 'takeExpress']);
    Route::get('/fetch/express/teen/histories', [ExpressDeliveryController::class, 'teenHistoricExpress']);
